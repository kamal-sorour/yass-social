...
export default function Login() {
  ...
  return (
    <>
      <SEO 
        title="Log In"
        description="Log in to your Yass Route account securely. Continue connecting with your favorite creators, friends, and communities."
        keywords="Yass Route login, sign in, access account, social media login"
        url="/login"
        type="website"
      />
